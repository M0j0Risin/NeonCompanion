// <auto-generated>
// Generated by tools/TzGen.cs from CLDR windowsZones.xml (typeVersion 2021a) plus the IANA backward links.
// Do not edit; rerun `dotnet run tools/TzGen.cs` from the repository root instead.
// </auto-generated>

namespace NeonSidekick.Llm.Tools;

/// <summary>
/// IANA → Windows time zone ids (CLDR's mapping, the same data ICU serves), because under
/// <c>InvariantGlobalization</c> <see cref="TimeZoneInfo.FindSystemTimeZoneById"/> knows only the
/// Windows form. Current and old IANA spellings both resolve (the IANA backward links are
/// folded in). Keys are compared ordinally, case-insensitive.
/// </summary>
public static class WindowsZones
{
    /// <summary>The CLDR <c>typeVersion</c> the table was generated from.</summary>
    public const string Version = "2021a";

    /// <summary>The Windows id for an IANA id, or false when CLDR has no mapping.</summary>
    ...
    /// <summary>How many IANA ids the table knows.</summary>
