...
public static class SlashCommands
{
    ...
    /// An alias goes in the first column with the command (<see cref="Label"/>), never in the summary — <c>//</c> is the one left (2026-09-16).
    /// </summary>
