...
public sealed class SqlConnectionConfig
{
    ...
    /// <summary>What <see cref="CredentialTarget"/> is for a connection that names no <see cref="Credential"/>: <c>NeonCompanion/sql/&lt;name&gt;</c>.</summary>
    public const string CredentialPrefix = "NeonCompanion/sql/";
    ...
    public SqlConnectionStringBuilder Builder(string? database = null, string? password = null)
    {
        ...
        else if (IsRunAs)
        {
            ...
            builder.ApplicationName = "NeonCompanion (runas)";
        }
        else
        {
