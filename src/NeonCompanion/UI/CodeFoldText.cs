...
/// for code): <c>▸ csharp · 57 lines</c>, the triangle down (<see cref="ToolGroupText.ExpandedGlyph"/>)
...
public static class CodeFoldText
{
    ...
    public static string Summary(string label, int lines, bool expanded)
    {
        ...
        return (expanded ? ToolGroupText.ExpandedGlyph : ToolGroupText.CollapsedGlyph) + " " + label + " · "
