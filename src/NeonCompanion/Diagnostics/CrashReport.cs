...
/// <see cref="FileName"/> under the settings directory (<c>%USERPROFILE%\.neoncompanion\crash.log</c>).
///
...
public static class CrashReport
{
    ...
    public static string Notice(string? path, Exception exception)
    {
        ...
        return $"NeonCompanion crashed: {exception.GetType().Name}: {exception.Message}. {where}";
    }
