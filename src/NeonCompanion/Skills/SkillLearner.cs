...
public static class SkillLearner
{
    ...
    public const string TurnOpening =
        "You are reviewing the last turns of a conversation between a user and Neon, a terminal companion with tools, to decide whether they taught a procedure worth keeping for later sessions as a skill. ";
    ...
    public const string SessionsOpening =
        "You are reviewing several earlier conversations between a user and Neon, a terminal companion with tools, to find a procedure the user has needed more than once, or a pitfall met more than once, worth keeping for later sessions as a skill. ";
