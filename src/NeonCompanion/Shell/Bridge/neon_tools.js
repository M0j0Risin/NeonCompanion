// NeonCompanion's tool bridge for a Node script run by execute_code.
//
...
const ADDRESS = process.env.NEONCOMPANION_BRIDGE_ADDRESS || "";
const TOKEN = process.env.NEONCOMPANION_BRIDGE_TOKEN || "";
