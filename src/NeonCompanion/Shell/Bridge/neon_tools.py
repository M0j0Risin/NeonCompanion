"""NeonCompanion's tool bridge for a Python script run by execute_code.
...
_ADDRESS = os.environ.get("NEONCOMPANION_BRIDGE_ADDRESS", "")
_TOKEN = os.environ.get("NEONCOMPANION_BRIDGE_TOKEN", "")
