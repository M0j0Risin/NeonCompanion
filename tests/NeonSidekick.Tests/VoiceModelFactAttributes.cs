...
/// variable first, then the app's own models directory (<c>NEONSIDEKICK_HOME</c> or
/// <c>%USERPROFILE%\.neonsidekick</c>), where <c>--voice-check</c> downloads them. Locally:
...
{
    public const string WhisperVariable = "NEONSIDEKICK_TEST_WHISPER_MODEL";
    public const string SileroVariable = "NEONSIDEKICK_TEST_SILERO_MODEL";
    public const string VoskVariable = "NEONSIDEKICK_TEST_VOSK_MODEL";
    public const string KokoroVariable = "NEONSIDEKICK_TEST_KOKORO_MODEL";
