...
public class SettingsMenuTests : IDisposable
{
    ...
    public async Task OverriddenField_IsLabelled_AndSavingWarns()
    {
        ...
        Assert.Contains("(overridden by NEONCOMPANION_LLM_MODEL)", _console.Output);
    ...
    public void Labels_ArePinned()
    {
        ...
        Assert.Equal("Hello. I am Neon, your friendly and concise terminal companion.", SettingsMenu.VoicePreviewText);   // the user's sentence (2026-09-15; "Hello from Kokoro." before)
    ...
    private static readonly string[] PreviewSentences = ["Hello.", "I am Neon, your friendly and concise terminal companion."];
